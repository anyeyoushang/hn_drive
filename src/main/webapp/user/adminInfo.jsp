...
<div class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center',title:'个人信息'" style="overflow: hidden;padding: 5px;" align="center">
		<form id="user_userInfo_form" method="post">
			<input name="id" type="hidden" value="${adminInfo.userId}" />
			<table class="tableForm">
				<tr>
					<th style="width: 55px;">登录名</th>
					<td><input readonly="readonly" value="${adminInfo.loginName}" /></td>
				</tr>
				<tr>
					<th>登录IP</th>
					<td><input readonly="readonly" value="${adminInfo.ip}" /></td>
				</tr>
				<tr>
					<th>修改密码</th>
				...
				<tr>
					<th>所属角色</th>
					<td><textarea readonly="readonly" style="height: 40px;width: 150px;">${adminInfo.roleNames}</textarea></td>
				</tr>
				<tr style="display: none;">
					<th>权限ID</th>
					<td><input name="resourceIds" value="${adminInfo.resourceIds}" /></td>
				</tr>
			</table>
		</form>
	</div>
