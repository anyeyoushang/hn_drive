...
public class JpushUtil {
	...
	public static void main(String[] args) {
		String AppKey = "3d256e0a985b145a90d9a86c";
		String MasterSecret = "0502320bae321786a9c65675";
		JPushClient jpushClient = new JPushClient(MasterSecret, AppKey);
		sendNoticeAlias(jpushClient, "恭喜你获得5M流量奖励", "18715083418");
	}
	 ...
	 * @param message
	 */
	public static void sendAll(String message, JPushClient jpushClient){
		try {
	 ...
	 * @param alias
	 */
	public static void sendNoticeAlias(JPushClient jpushClient, String notification, String ... alias){
		sendNoticeAlias(jpushClient, notification, null, alias);
	}
	 ...
	 */
	public static void sendNoticeAlias(JPushClient jpushClient, String notification, 
			 Map<String, String> extra, String ...alias){
		try {
			// 创建ios的通知对象
	 ...
	 * @param alias
	 */
	public static void sendAlias(JPushClient jpushClient, String messageTitle, String notification, String ...alias){
		try {
	 ...
	 * @param alias 别名,可以有多个
	 */
	public static void sendMapAlias(JPushClient jpushClient, String messageTitle, String notification, 
			Map<String, String> extra, String ...alias){
		try {
			Builder builder = Message.newBuilder();
			// 创建ios的通知对象
	 ...
	 * @param alias
	 */
	public static void sendAliasMap(JPushClient jpushClient, String messageTitle, String notification, 
			PushPlatform pushPlatform, Map<String, String> extra, String ...alias){
		try {
			Builder builder = Message.newBuilder();
			// 创建ios的通知对象
			IosNotification.Builder iosBuilder = IosNotification.newBuilder().autoBadge().setSound("default");
	 ...
	 */
	public static void sendTag(JPushClient jpushClient, String notification,String message,PushPlatform platfrom,String...tag){
		PushPayload pushPayload=PushPayload.newBuilder()
	 ...
	 * @param device
	 */
	public static void jSend_notification(JPushClient jpushClient, String alert, String[] tags,
	 ...
	 * 
	 */
	public static boolean JSend_Message(JPushClient jpushClient,String title, String msg,
	 ...
	 * @return
	 */
	public static boolean JSend_MessageHasSound(JPushClient jpushClient,String title, String msg,
			String[] tags, String[] loginName, String device,
			final Map<String, String> extra) {
		boolean flag = false;
		Audience at = pushPeople(tags, loginName);
	 ...
	 * @return
	 */
	public static boolean JSend_MessageNotSound(JPushClient jpushClient,String title, String msg,
			String[] tags, String[] loginName, String device,
			final Map<String, String> extra) {
		boolean flag = false;
		Audience at = pushPeople(tags, loginName);
