 ...
 * @since 2016年1月23日
 */
public class DriverJpushUtil {
	protected static final Logger LOG = LoggerFactory.getLogger(DriverJpushUtil.class);
...
//			andBuilder.addExtras(extra);
	...
	public static void jSend_notification(String alert, String[] tags,
		...
		JPushClient jpushClient = DriverJpushUtil.jpushClient;
